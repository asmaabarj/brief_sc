...
<body>
    ...
    <main class="flex justufy-center flex-col ">
        <div class="bg-gray-50  mt-2 outline-none border-gray-400 border-solid border-[1px] flex px-4 h-10 w-[50vw] m-auto">
            ...
            <input type='text' id="searchInput" placeholder='Search...' class=" outline-none w-[50vw] bg-gray-50 text-black text-sm" />
        </div>
        <div class="bg-white p-4 w-[95%] m-auto font-[sans-serif]">
            <div>
                ...
                <div id="searchcontainer" class=" hidden grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                </div>
                <div id="wikisContainer" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    <?php
                        ...
                        <div class="bg-white rounded-lg overflow-hidden hover:scale-105 transition-all duration-300">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex justify-between items-center">
                                    <form action="../../controllers/ConWikipage.php" method="post">
                                        <button type="submit" name="show" value="<?= $archive->__get('id'); ?>" class="mt-4 inline-block text-blue-600 text-sm hover:underline ">Read More</button>
                                    </form>
                                </div>
                            </div>
                        </div>
