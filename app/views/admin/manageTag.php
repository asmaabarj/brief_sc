...
<body class="text-gray-800 font-inter">
    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-gray-100 p-4 z-50 sidebar-menu transition-transform">
        <a href="dashboard.php" class="flex items-center pb-4 border-b border-b-gray-800">
            <img src="../../../public/images/wikilogo.png" alt="" class="w-16 h-12">
        </a>
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-50 min-h-screen transition-all main">
        <div class="py-2 px-6 bg-black flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">
            ...
            <ul class="flex items-center text-sm ml-4">
                ...
                <li class="text-white mr-2 font-medium">Manage Tags</li>
            </ul>
          ...
          ?>
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="nameTag" required value="<?=$name?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type Tag name" required="">
                    </div>
      ...
      <tr class="odd:bg-blue-50">
        <td class="px-6 py-3 text-sm">
          <div class="flex items-center cursor-pointer">
            <div class="ml-4">
              <p class="text-sm text-black"><?=$TAG->__get('tag_name');?></p>
            </div>
          </div>
        </td>
        <td class="px-6 py-3">
