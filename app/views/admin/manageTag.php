...
<aside id="logo-sidebar" class="fixed top-0 left-0 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 bg-gray-100 ">
      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a href="managrCategory.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
...
<div class="bg-black h-48 w-full  ml-64 ">
    <h1 class="text-white text-gray-100 mt-10 text-xl font-bold	ml-10">MANAGE TAGS</h1>